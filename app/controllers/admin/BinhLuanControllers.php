...
function xoaBinhLuan()
{
    ...
    if (deleteBinhLuan($ma_binh_luan)) {
        $tbao = "Xóa thành công";
        echo "<script>window.location.href='?url=admin/binhluan&tb=$tbao&type=success'</script>";
    } else {
        $tbao = "Xóa không thành công";
        echo "<script>window.location.href='?url=admin/binhluan&tb=$tbao&type=danger'</script>";
    }
}
function xoaChiTietBinhLuan()
{
    ...
    if (deleteChiTietBinhLuan($ma_chi_tiet_binh_luan)) {
        $tbao = "Xóa thành công";
        echo "<script>window.location.href='?url=admin/binhluan/traloi&ma_binh_luan=$ma_binh_luan&tb=$tbao&type=success'</script>";
    } else {
        $tbao = "Xóa  không thành công";
        echo "<script>window.location.href='?url=admin/binhluan/traloi&ma_binh_luan=$ma_binh_luan&tb=$tbao&type=danger'</script>";
    }
}
